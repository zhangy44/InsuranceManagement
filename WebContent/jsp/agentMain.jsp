...
<% HttpSession s=request.getSession(false);  
    ...
    List<LoginBean> lbl = ld.findClients(userid);
    request.setAttribute("allClients",lbl);
        ...
        <div class="card card-profile shadow mt--300">
          <div class="px-4">
            ...
            <div class="text-center mt-5">
              ...
              <div class="h6 font-weight-300"><i class="ni location_pin mr-2"></i>View All My Clients</div>
